document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        en: {
            ...
            proj4Desc: '(Project description updating...)',
            proj4F1: 'Python Development Environment',
            proj4F2: 'Stock Data Analysis & Automation',
            proj4F3: '(Details to be added)',
            proj5Desc: '(Project description updating...)',
            proj5F1: 'Python Development Environment',
            proj5F2: 'Literature Reading & Processing Tools',
            proj5F3: '(Details to be added)',
