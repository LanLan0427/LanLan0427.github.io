document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        zh: {
            ...
            proj3F3: '完全響應式與無障礙優化',
            proj4Desc: 'Sui 生態 AI 助手與鏈上資料分析專案。',
            proj4F1: '整合 Sui RPC 與鏈上數據查詢',
            proj4F2: '以 Gemini 提供即時專案解析與摘要',
            proj4F3: '聚焦 Sui 生態追蹤與研究輔助',
            proj5Desc: '基於 opBNB 的 AI 驅動虛擬交易 Discord 機器人，先後 <strong class="highlight-purple">參與</strong> 了 <strong class="highlight-purple">BNB Hack: Online Edition</strong> 與 <strong class="highlight-purple">UK AI Agent Hackathon EP4 x OpenClaw</strong>。',
            proj5F1: '串接 <strong>Google Gemini AI</strong>，提供幽默毒舌風格的即時市場洞察。',
            proj5F2: '結合 <strong>opBNB</strong> 鏈上聲譽系統，安全存儲交易者投資回報率 (ROI)。',
            proj5F3: '透過 <strong>ccxt (Binance API)</strong> 獲取即時 K 線報價，提供社交化的無風險交易練習。',
            ...
            eventsTitle: '社群與活動',
            event1Title: 'Build with AI: Taichung AI Studio',
            event1Org: 'Google Developer Groups (GDG) Taichung',
            event2Title: '第九屆《Hit AI & Blockchain》人工智慧暨區塊鏈產業高峰會',
            event2Org: 'Knowing新聞 (KNOWING News)',
            event2Desc: '參加第九屆《Hit AI & Blockchain》高峰會，與業界領袖深度探討 AI Agent 企業級應用、RWA 代幣化與全球算力重組佈局。聚焦 AI 與 Web3 跨界發展利基。',
            event2Date: '2026/03/26',
        ...
        en: {
            ...
            proj4Desc: 'Sui ecosystem AI assistant and on-chain analytics project.',
            proj4F1: 'Integrates Sui RPC and on-chain data queries',
            proj4F2: 'Uses Gemini for real-time project analysis and summaries',
            proj4F3: 'Focused on Sui ecosystem tracking and research assistance',
            proj5Desc: 'AI-driven mock trading Discord bot on opBNB, a participant in both <strong class="highlight-purple">BNB Hack: Online Edition</strong> and <strong class="highlight-purple">UK AI Agent Hackathon EP4 x OpenClaw</strong>.',
            proj5F1: 'Powered by <strong>Google Gemini AI</strong> for sharp, humorous, and real-time market insights.',
            proj5F2: 'Integrated with <strong>opBNB</strong> on-chain reputation system to securely store player ROI.',
            proj5F3: 'Real-time market data via <strong>ccxt (Binance API)</strong> for a socialized risk-free trading experience.',
            viewGithub: 'View on GitHub',
            viewBuidl: 'View BUIDL',
            viewDemo: 'Watch Demo',
            ...
            event1Title: 'Build with AI: Taichung AI Studio',
            event1Org: 'Google Developer Groups (GDG) Taichung',
            event2Title: '9th Hit AI & Blockchain Summit',
            event2Org: 'KNOWING News',
            event2Desc: 'Attended the 9th Hit AI & Blockchain Summit, analyzing Enterprise-level AI Agent applications, RWA tokenization, and global computing power restructuring. Focusing on AI & Web3 cross-domain synergies.',
            event2Date: '2026/03/26',
        ...
        const commands = {
            ...
            'projects': () => {
                return [
                    ...
                    '  <span class="terminal-purple">▸</span> <span class="cmd">Sui_Degen</span>',
