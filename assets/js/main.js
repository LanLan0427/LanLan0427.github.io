document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        zh: {
            ...
            proj5Desc: '基於 opBNB 的 AI 驅動虛擬交易 Discord 機器人，先後於 <strong class="highlight-purple">BNB Hack: Online Edition</strong> 與 <strong class="highlight-purple">UK AI Agent Hackathon EP4 x OpenClaw</strong> 榮獲肯定。',
        ...
        en: {
            ...
            proj5Desc: 'AI-driven mock trading Discord bot on opBNB, a proud participant in both <strong class="highlight-purple">BNB Hack: Online Edition</strong> and <strong class="highlight-purple">UK AI Agent Hackathon EP4 x OpenClaw</strong>.',
