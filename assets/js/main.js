document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        zh: {
            ...
            proj5Desc: '基於 opBNB 的 AI 驅動虛擬交易 Discord 機器人，榮獲 <strong class="highlight-purple">UK AI Agent Hackathon EP4 x OpenClaw</strong> 肯定。',
        ...
        en: {
            ...
            proj5Desc: 'AI-driven mock trading Discord bot on opBNB, developed for <strong class="highlight-purple">UK AI Agent Hackathon EP4 x OpenClaw</strong>.',
